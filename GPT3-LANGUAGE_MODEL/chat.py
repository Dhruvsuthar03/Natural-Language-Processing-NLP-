...
for intent in intents["intents"]:
    for pattern in intent["patterns"]:
        ...
        # Adding words to document with tag given in intents file
...
for doc in documents:
    ...
    # It will give output 1 for current tag and 0 for all others tags
...
# Now we have set up model, now we need to train that model by fitting data into it by model.fit()
